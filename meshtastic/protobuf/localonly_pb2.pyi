...
class LocalModuleConfig(google.protobuf.message.Message):
    ...
    @property
    def kiezbox_control(self) -> meshtastic.protobuf.module_config_pb2.ModuleConfig.KiezboxControlConfig:
        """
    ...
    def __init__(
        ...
        *,
        ...
        kiezbox_control: meshtastic.protobuf.module_config_pb2.ModuleConfig.KiezboxControlConfig | None = ...,
        version: builtins.int = ...,
    ) -> None: ...
